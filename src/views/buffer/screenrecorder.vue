        ...
        <div class="col-xl-auto">
          <a-card title="屏幕录制">
            <div class="card-body">
              <div class="row">
                <div>
                  <div class="record_voice_askbox">                    
                    ...
                    <a-input type="checkbox" v-model="checked" class="record_voice_checkbox_merge" id="audio" :disabled="isStart && !isFinish" />
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <a-row>
                <a-button type="primary" :disabled="isStart" @click="onStartBtn" class="action_btn_style">开始录制</a-button>
                <a-button type="danger" :disabled="!isStart" @click="onEndBtn" class="action_btn_style">结束录制</a-button>
                <a-button type="primary" :disabled="!isFinish" @click="onDownloadBtn" class="action_btn_style">下载录制结果</a-button>
              </a-row>
            </div>
          </a-card>
        </div>
